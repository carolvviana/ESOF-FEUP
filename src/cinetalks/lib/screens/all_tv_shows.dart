...
// class AlltvshowsPage extends StatelessWidget {
//   final List<Map<String, dynamic>> tvshows;
  
//   const AlltvshowsPage({Key? key, required this.tvshows}) : super(key: key);
...
//                   items: tvshows.map((movie) => Movie(id: movie['id'], 
//                   title: movie['title'],
